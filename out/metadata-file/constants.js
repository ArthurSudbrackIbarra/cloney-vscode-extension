...
// Name.
const nameItem = createFieldCompletionItem("template_name", "The name of your Cloney template, providing a clear identifier for users.", true, "# (Required) The name of your Cloney template, providing a clear identifier for users.\nname: ${1:Template Name}");
// Description.
const descriptionItem = createFieldCompletionItem("template_description", "A brief but informative description of your Cloney template.", false, "# (Optional) A brief but informative description of your Cloney template.\ndescription: ${1:Template Description}");
// Template Version.
...
// Ignore Paths.
const ignorePathsItem = createFieldCompletionItem("ignore_paths", "A list of paths to ignore when cloning the template. This is useful for excluding files that are not relevant to the template's customization process.", false, "ignore_paths:\n  - ${1:path_to_ignore} # (Optional) A list of paths to ignore when cloning the template. This is useful for excluding files that are not relevant to the template's customization process.");
// Variables.
...
const variableDescriptionItem = createFieldCompletionItem("variable_description", "A description of the variable, providing context for users.", false, "description: ${1:variable_description} # A description of the variable, providing context for users.");
// Variable Default.
const variableDefaultItem = createFieldCompletionItem("variable_default_value", "The default value of a variable.", false, "default: ${1:variable_default_value} # (Optional) The default value of the variable.");
// Variable Example.
const variableExampleItem = createFieldCompletionItem("variable_example_value", "An example value of the variable.", true, "example: ${1:variable_example_value} # (Required) An example value of the variable.");
// Export fields.
