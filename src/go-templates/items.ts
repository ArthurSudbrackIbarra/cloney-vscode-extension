...
defineItem.documentation = new vscode.MarkdownString(
  "The 'define' function is used to create a named template. " +
...
templateItem.documentation = new vscode.MarkdownString(
  "The 'template' function is used to include a named template in the template. " +
...
ifItem.documentation = new vscode.MarkdownString(
  "The 'if' function is used to conditionally render a block of content. " +
...
rangeItem.documentation = new vscode.MarkdownString(
  "The 'range' function is used to iterate over a list of items. " +
...
withItem.documentation = new vscode.MarkdownString(
  "The 'with' function is used to set the context for a block of content. " +
